                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form id="form_banner" method="POST" action="/banner/store_banner" enctype="multipart/form-data">
                                        <div class="row">
                                            @csrf
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('banner_label') is-invalid @enderror " placeholder="Label Button" name="banner_label" id="label_button" value="<?= old('label_button') ?>">
                                                </div>
                                                @error('banner_label')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
