                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form id="form_category" method="POST" action="/category/store_category" enctype="multipart/form-data">
                                        <div class="row">
                                            @csrf
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" readonly class="form-control @error('slug') is-invalid @enderror " placeholder="Slug" name="slug" id="slug" value="<?= old('slug') ?>">
                                                </div>
                                                @error('slug')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
